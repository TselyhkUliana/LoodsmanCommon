namespace LoodsmanCommon
{
  ...
  /// <summary> Режим возврата информации об атрибуте. </summary>
  public enum GetInfoAboutAttributeMode
  {
    /// <summary> Возвращает полный список свойств атрибута. 
    /// <br/>Возвращает набор данных с полями:
    ...
    /// </summary>
    Mode1 = 1,
    /// <summary> Возвращает список идентификаторов сущностей, которые может измерять данный атрибут.
    /// <br/>Возвращает набор данных с полями:
    /// <br/>[_ID] int – уникальный идентификатор атрибута;
    /// <br/>[_ID_MEASURE] string – уникальный идентификатор сущности;
    /// <br/>[_NAME] string – отображаемое имя сущности;
    /// <br/>[_DEFAULT] int – признак сущности по умолчанию (1 – умолчательная, 0 – обычная).
    /// </summary>
    Mode2 = 2
  }
